package xyz.wongs.basic.config;
 ...
 */
@Configuration
//@ConditionalOnProperty(prefix = "leo", name = "swagger-open", havingValue = "true")
//@ComponentScan(basePackages = {"org.leo.*.controller.*"})//配置controller路径
@EnableSwagger2
